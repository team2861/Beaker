...
/**
 *	The Swerve Modifier will take in a Source Trajectory and spit out 4 trajectories,
 *	1 for each wheel on the drive.  This is commonly used in robotics for robots with
 *	4 individual wheels in a 'swerve' configuration, where each wheel can rotate to a
 *	specified heading while still being powered.  The Source Trajectory is measured
 *	from the center of the drive base.  The modification will not modify the central
 *	trajectory.
 */
